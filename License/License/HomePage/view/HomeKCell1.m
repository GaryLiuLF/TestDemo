...
@interface HomeKCell1()

@property (nonatomic,strong) UIScrollView *scrollView;

@end

@implementation HomeKCell1
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if(self){
        ...
        NSArray*array = @[@{@"image":@"ic_shunxu",@"title":@"顺序训练",@"content":@"(共1300题：已做：0题)",@"type":@"0"},
                          ...
                          @{@"image":@"ic_kaoshi",@"title":@"科一考试预约报名",@"content":@"取消预约报名费可退",@"type":@"0"}];
...
- (void)refrsh;{
    ...
    if(itemView){
        NSArray*array = [[DBTool sharedDB] getSunxuDatasWithSubType:1];
